...
import { ArrowRight, Sparkles, Brain, Cpu, Network, ChevronDown, Zap, Globe } from 'lucide-react';
  ...
  return (
    <div className="relative min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <Brain className="absolute top-1/4 left-1/4 h-16 w-16 text-blue-500/20 animate-float" style={{ animationDelay: '0s' }} />
        <Cpu className="absolute top-1/3 right-1/4 h-12 w-12 text-emerald-500/20 animate-float" style={{ animationDelay: '2s' }} />
        <Network className="absolute bottom-1/4 left-1/3 h-14 w-14 text-blue-500/20 animate-float" style={{ animationDelay: '4s' }} />
        <Zap className="absolute top-1/2 right-1/3 h-10 w-10 text-emerald-500/20 animate-float" style={{ animationDelay: '1s' }} />
        <Globe className="absolute bottom-1/3 right-1/2 h-12 w-12 text-blue-500/20 animate-float" style={{ animationDelay: '3s' }} />
        ...
        <div className="absolute top-1/4 right-1/4 w-40 h-40 bg-gradient-to-r from-blue-500/10 to-emerald-500/10 rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          {/* Enhanced Hero Title */}
          <h1 className="reveal opacity-0 text-5xl md:text-7xl font-bold tracking-tight space-y-4" style={{ animationDelay: '0.2s' }}>
          ...
          {/* Enhanced Subtitle */}
          <p className="reveal opacity-0 text-3xl font-semibold gradient-text tracking-wide" style={{ animationDelay: '0.4s' }}>
            Real-Time Intelligence
          </p>
          
          {/* Enhanced Description */}
          <p className="reveal opacity-0 max-w-2xl text-xl text-gray-600 leading-relaxed" style={{ animationDelay: '0.6s' }}>
            ARCS Scientific pioneers breakthrough research in cognitive systems and AI, 
            developing innovative solutions that push the boundaries of what's possible.
          </p>
          
          {/* Enhanced CTA Buttons */}
          <div className="reveal opacity-0 flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4" style={{ animationDelay: '0.8s' }}>
