...
import { Shield, FileSearch, GitCompare, Settings, ArrowRight } from 'lucide-react';

const features = [
  {
    icon: Shield,
    title: 'Real-Time Compliance Monitoring',
    description: 'Advanced AI systems continuously analyze and adapt to regulatory changes, ensuring proactive compliance across all operations.',
    gradient: 'from-blue-500 to-blue-600'
  },
  {
    icon: FileSearch,
    title: 'Quantum Document Structuring',
    description: 'Revolutionary quantum-inspired algorithms that transform unstructured data into actionable regulatory insights.',
    gradient: 'from-emerald-500 to-emerald-600'
  },
  {
    icon: GitCompare,
    title: 'Market Relevance Cross-Referencing',
    description: 'Intelligent systems that correlate market dynamics with regulatory requirements for contextual compliance.',
    gradient: 'from-blue-600 to-emerald-500'
  },
  {
    icon: Settings,
    title: 'Dynamic Regulatory Adaptation',
    description: 'Self-evolving frameworks that automatically adjust to new compliance requirements and industry standards.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 reveal opacity-0">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Pioneering the future of regulatory intelligence with quantum-inspired solutions
          </p>
        </div>
              ...
              <div className="relative glass-card p-8 rounded-2xl hover-glow h-full flex items-start space-x-6 transform transition-all duration-300 group-hover:-translate-y-1">
                <div className="flex-shrink-0">
                  <div className="relative">
                    ...
                    <feature.icon className={`relative h-12 w-12 bg-gradient-to-r ${feature.gradient} rounded-xl p-2.5 text-white transform group-hover:scale-110 transition-all duration-300`} />
                  </div>
                </div>
        ...
        <div className="flex justify-center reveal opacity-0" style={{ animationDelay: '0.8s' }}>
        ...
        <div className="absolute bottom-1/4 left-0 w-96 h-96 bg-gradient-to-r from-emerald-500/10 to-blue-500/10 rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: '2s' }} />
      </div>
    </section>
  );
}