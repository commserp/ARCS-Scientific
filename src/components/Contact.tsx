      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 reveal opacity-0">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Connect with us to explore how ARCS Institute can transform your regulatory compliance
          </p>
        </div>
          ...
          <div className="lg:pl-12">
            <div className="grid gap-8">
              {contactInfo.map((info, index) => (
                ...
                >
                  <div className={`absolute -inset-0.5 bg-gradient-to-r ${info.gradient} rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-300 blur`} />
                  <div className="relative glass-card p-6 rounded-2xl hover-glow flex items-center space-x-4">
                    <div className="relative">
                      <div className={`absolute -inset-1 bg-gradient-to-r ${info.gradient} rounded-lg opacity-0 group-hover:opacity-75 blur transition-all duration-300`} />
                      <info.icon className={`relative h-6 w-6 text-gray-600 group-hover:text-blue-600 transition-colors duration-300`} />
                    </div>
                    <div>
              ...
              {/* Map Preview */}
              <div className="reveal opacity-0" style={{ animationDelay: '1s' }}>
                <div className="relative group">
                  ...
                  <div className="relative rounded-2xl overflow-hidden hover-glow">
                    <img
                      src="https://images.unsplash.com/photo-1577743401035-6d49752eaf51?auto=format&fit=crop&q=80&w=800&h=400"
                      alt="Location"
